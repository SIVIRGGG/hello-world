...
namespace kursach_v_0._1
{
    public partial class Form7 : Form
    {
        ...
        {
            MessageBox.Show("Загружено из файла D:\\MServicesDB.dat");
            data.LoadFromFile();
        ...
        {
            MessageBox.Show("Сохранено в файл D:\\MServicesDB.dat");
            data.SaveToFile();
        }
        ...
        {
            if (comboBox2.Text == "Медицинская услуга")
                data.Sort();
            else
         if (comboBox2.Text == "Лечебная процедура")
                data.Sort1();
            else
        ...
        {
            int t = 0;
            if (comboBox1.Text == "Медицинская услуга")
                t = 1;
            else
                if (comboBox1.Text == "Лечебная процедура")
                t = 2;
            else
